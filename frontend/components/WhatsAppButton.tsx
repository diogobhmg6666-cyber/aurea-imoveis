...
type Props = { numero: string; mensagem?: string }

export default function WhatsAppButton({ numero, mensagem = 'Olá! Vi o site da Bem Morar Imóveis e gostaria de conversar.' }: Props) {
  ...
  return (
    ...
    >
      ...
      {hover && <span className="wpp-label">Fale conosco</span>}
